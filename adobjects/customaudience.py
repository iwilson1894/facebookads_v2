...
from facebookads_v2.adobjects.helpers.customaudiencemixin import CustomAudienceMixin
...
class CustomAudience(
    ...
    def get_prefills(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.customaudienceprefillstate import CustomAudiencePrefillState
        param_types = {
        }
        enums = {
        }
    ...
    def get_sessions(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.customaudiencesession import CustomAudienceSession
        param_types = {
    ...
    def create_user(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.user import User
        param_types = {
            'namespace': 'string',
            'payload': 'Object',
            'session': 'Object',
