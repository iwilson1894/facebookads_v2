...
from facebookads_v2.mixins import CanValidate
...
class AdSet(
    ...
    def get_async_ad_requests(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adasyncrequest import AdAsyncRequest
        param_types = {
    ...
    def get_delivery_estimate(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adcampaigndeliveryestimate import AdCampaignDeliveryEstimate
        param_types = {
            'optimization_goal': 'optimization_goal_enum',
            'promoted_object': 'Object',
