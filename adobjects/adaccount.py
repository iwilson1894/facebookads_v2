...
from facebookads_v2.adobjects.helpers.adaccountmixin import AdAccountMixin
from facebookads_v2.mixins import HasAdLabels
...
class AdAccount(
    ...
    def get_activities(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adactivity import AdActivity
        param_types = {
            'add_children': 'bool',
            'business_id': 'string',
    ...
    def get_ad_place_page_sets(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adplacepageset import AdPlacePageSet
        param_types = {
        }
        enums = {
        }
    ...
    def get_ad_creatives(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adcreative import AdCreative
        param_types = {
        }
        enums = {
        }
    ...
    def get_ad_images(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adimage import AdImage
        param_types = {
    ...
    def get_ad_labels(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adlabel import AdLabel
        param_types = {
        }
        enums = {
        }
    ...
    def get_ad_report_runs(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adreportrun import AdReportRun
        param_types = {
        }
        enums = {
        }
    ...
    def get_ad_rules_history(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adaccountadruleshistory import AdAccountAdRulesHistory
        param_types = {
    ...
    def create_ad_rules_library(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adrule import AdRule
        param_types = {
            'account_id': 'string',
    ...
    def get_ads(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.ad import Ad
        param_types = {
            'ad_draft_id': 'string',
    ...
    def get_ad_sets(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adset import AdSet
        param_types = {
            'ad_draft_id': 'string',
            'date_preset': 'date_preset_enum',
    ...
    def get_ads_pixels(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adspixel import AdsPixel
        param_types = {
        }
        enums = {
        }
    ...
    def get_async_ad_request_sets(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adasyncrequestset import AdAsyncRequestSet
        param_types = {
            'is_completed': 'bool',
        }
        enums = {
    ...
    def get_broad_targeting_categories(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.broadtargetingcategories import BroadTargetingCategories
        param_types = {
    ...
    def delete_campaigns(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.campaign import Campaign
        param_types = {
    ...
    def get_custom_audiences(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.customaudience import CustomAudience
        param_types = {
            'business_id': 'string',
    ...
    def get_custom_audiences_tos(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.customaudiencestos import CustomAudiencesTOS
        param_types = {
        }
        enums = {
        }
    ...
    def create_custom_conversion(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.customconversion import CustomConversion
        param_types = {
    ...
    def get_delivery_estimate(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adaccountdeliveryestimate import AdAccountDeliveryEstimate
        param_types = {
            'optimization_goal': 'optimization_goal_enum',
            'promoted_object': 'Object',
    ...
    def get_generate_previews(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adpreview import AdPreview
        param_types = {
    ...
    def get_insights(self, fields=None, params=None, async_var=False, batch=None, pending=False):
        from facebookads_v2.adobjects.adsinsights import AdsInsights
        if async_var:
    ...
    def get_lead_gen_forms(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.leadgenform import LeadgenForm
        param_types = {
            'query': 'string',
        }
        enums = {
    ...
    def get_minimum_budgets(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.minimumbudget import MinimumBudget
        param_types = {
            'bid_amount': 'int',
        }
        enums = {
    ...
    def get_offline_conversion_data_sets(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.offlineconversiondataset import OfflineConversionDataSet
        param_types = {
        }
        enums = {
        }
    ...
    def get_offsite_pixels(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.offsitepixel import OffsitePixel
        param_types = {
        }
        enums = {
        }
    ...
    def get_partner_categories(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.partnercategory import PartnerCategory
        param_types = {
            'hide_pc': 'bool',
    ...
    def get_partners(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adsdatapartner import AdsDataPartner
        param_types = {
        }
        enums = {
        }
    ...
    def get_rate_card(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.ratecard import RateCard
        param_types = {
        }
        enums = {
        }
    ...
    def get_reach_estimate(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.reachestimate import ReachEstimate
        param_types = {
            'currency': 'string',
            'daily_budget': 'float',
    ...
    def get_reach_frequency_predictions(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.reachfrequencyprediction import ReachFrequencyPrediction
        param_types = {
        }
        enums = {
        }
    ...
    def get_roas(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adaccountroas import AdAccountRoas
        param_types = {
            'fields': 'list<fields_enum>',
            'filtering': 'list<Object>',
            'time_increment': 'string',
    ...
    def get_targeting_browse(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adaccounttargetingunified import AdAccountTargetingUnified
        param_types = {
            'include_nodes': 'bool',
    ...
    def get_targeting_sentence_lines(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.targetingsentenceline import TargetingSentenceLine
        param_types = {
            'discard_ages': 'bool',
    ...
    def get_transactions(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.transaction import Transaction
        param_types = {
            'time_start': 'int',
            'time_stop': 'int',
        }
    ...
    def get_users(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adaccountuser import AdAccountUser
        param_types = {
        }
        enums = {
        }
