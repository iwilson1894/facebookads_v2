...
from facebookads_v2.adobjects.helpers.productcatalogmixin import ProductCatalogMixin
...
class ProductCatalog(
    ...
    def get_check_batch_request_status(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.checkbatchrequeststatus import CheckBatchRequestStatus
        param_types = {
            'handle': 'string',
        }
        enums = {
    ...
    def get_external_event_sources(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.externaleventsource import ExternalEventSource
        param_types = {
        }
        enums = {
        }
    ...
    def get_hotel_rooms_batch(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.productcataloghotelroomsbatch import ProductCatalogHotelRoomsBatch
        param_types = {
            'handle': 'string',
        }
        enums = {
    ...
    def get_hotels(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.hotel import Hotel
        param_types = {
            'bulk_pagination': 'bool',
            'filter': 'Object',
        }
    ...
    def get_pricing_variables_batch(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.productcatalogpricingvariablesbatch import ProductCatalogPricingVariablesBatch
        param_types = {
            'handle': 'string',
        }
        enums = {
    ...
    def get_product_feeds(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.productfeed import ProductFeed
        param_types = {
        }
        enums = {
        }
    ...
    def get_product_groups(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.productgroup import ProductGroup
        param_types = {
        }
        enums = {
        }
    ...
    def get_product_sets(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.productset import ProductSet
        param_types = {
            'ancestor_id': 'string',
            'has_children': 'bool',
            'parent_id': 'string',
    ...
    def get_products(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.productitem import ProductItem
        param_types = {
            'bulk_pagination': 'bool',
            'filter': 'Object',
        }
