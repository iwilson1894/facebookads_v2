...
from facebookads_v2.adobjects.helpers.businessmixin import BusinessMixin
...
class Business(
    ...
    def create_ad_study(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.adstudy import AdStudy
        param_types = {
            'cells': 'list<Object>',
    ...
    def get_client_pages(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.page import Page
        param_types = {
        }
        enums = {
        }
    ...
    def get_event_source_groups(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.eventsourcegroup import EventSourceGroup
        param_types = {
        }
        enums = {
        }
    ...
    def create_owned_product_catalog(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.productcatalog import ProductCatalog
        param_types = {
    ...
    def get_pending_client_ad_accounts(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.businessadaccountrequest import BusinessAdAccountRequest
        param_types = {
        }
        enums = {
        }
    ...
    def get_pending_owned_ad_accounts(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.legacybusinessadaccountrequest import LegacyBusinessAdAccountRequest
        param_types = {
        }
        enums = {
        }
    ...
    def get_picture(self, fields=None, params=None, batch=None, pending=False):
        from facebookads_v2.adobjects.profilepicturesource import ProfilePictureSource
        param_types = {
            'height': 'int',
            'redirect': 'bool',
            'type': 'type_enum',
